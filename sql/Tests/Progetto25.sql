...
-- Crea il progetto
INSERT INTO `projects` (`id`, `name`, `versioning_url`) VALUES (1, 'Progetto 25', 'https://github.com/mattmezza/repominerEvo.git');
...
INSERT INTO `types` (`id`, `lines_number`, `src_file_location`, `source_container`) VALUES (2, 0, 'Secondo.java', 1);
